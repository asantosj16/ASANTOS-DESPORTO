      ...
      <div className="grid lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 glass-card p-10 rounded-[2.5rem]">
          ...
          <div className="space-y-6">
            ...
            <input type="number" value={weight} onChange={(e) => setWeight(Number(e.target.value))} className="w-full bg-slate-900 border border-slate-800 rounded-xl p-4 text-white font-bold"/></div>
            <div><label className="block text-[10px] font-black text-slate-500 uppercase mb-2">Objetivo</label>
            <select value={goal} onChange={(e) => setGoal(e.target.value as any)} className="w-full bg-slate-900 border border-slate-800 rounded-xl p-4 text-white font-bold appearance-none">
        ...
        <div className="lg:col-span-2 glass-card p-10 rounded-[2.5rem] border-green-500/10">
          <div className="flex items-center justify-between mb-12">
             <h4 className="text-green-500 font-black uppercase text-xs tracking-widest">Estimativa Diária Recomendada</h4>
             <div className="bg-green-500/10 px-4 py-2 rounded-full border border-green-500/20 text-white font-black">{macros.kcals} kcal</div>
          </div>
