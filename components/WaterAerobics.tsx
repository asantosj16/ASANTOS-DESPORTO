...
const WATER_EXERCISES: AerobicExercise[] = [
  { name: "Corrida Estacionária", category: "Cardio", instructions: "Correr sem sair do lugar, elevando joelhos a 90º.", focus: "Aquecimento sistémico", intensity: "Média", videoUrl: "#" },
  { name: "Polichinelo Aquático", category: "Cardio", instructions: "Abrir e fechar pernas e braços em simultâneo.", focus: "Cardiovascular", intensity: "Alta", videoUrl: "#" },
  { name: "Sessão de Bicicleta", category: "Localizada", instructions: "Apoiado no esparguete, pedalar em suspensão.", focus: "Abdómen e Pernas", intensity: "Média", videoUrl: "#" },
  { name: "Remada de Peito", category: "Membros Superiores", instructions: "Mãos em concha, empurrar água para os lados.", focus: "Peitoral e Dorsais", intensity: "Alta", videoUrl: "#" },
  { name: "Salto Tesoura", category: "Pliometria", instructions: "Alternar pernas em tesoura com salto explosivo.", focus: "Potência de membros inferiores", intensity: "Alta", videoUrl: "#" },
  { name: "Twist de Cintura", category: "Core", instructions: "Rotação de anca com pés fixos ou em salto.", focus: "Oblíquos", intensity: "Média", videoUrl: "#" },
  { name: "Impulsão Vertical", category: "Cardio", instructions: "Salto vertical saindo totalmente da água.", focus: "Explosão muscular", intensity: "Alta", videoUrl: "#" },
  { name: "Braços em Cruz", category: "Membros Superiores", instructions: "Movimento circular com braços estendidos.", focus: "Mobilidade e força de ombros", intensity: "Baixa", videoUrl: "#" }
];
    ...
    <div className="glass-card rounded-3xl overflow-hidden animate-fade-in-up stagger-4 opacity-0" style={{ animationFillMode: 'forwards' }}>
      ...
      <div className="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {WATER_EXERCISES.map((exercise, idx) => (
          <div key={idx} className="bg-slate-900/40 border border-slate-800 p-6 rounded-3xl hover:border-cyan-500/30 transition-all flex flex-col">
